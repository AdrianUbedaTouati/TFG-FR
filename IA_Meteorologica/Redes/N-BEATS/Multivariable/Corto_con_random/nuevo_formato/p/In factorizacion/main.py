...
class Config:
    ...
    # Rendimiento / GPU
    USE_AMP: bool = True                  # Mixto precisión con autocast+GradScaler
    ENABLE_TF32: bool = True             # TensorFloat32 (Ampere: RTX 30xx)
    TORCH_COMPILE: bool = True           # torch.compile (PyTorch 2.x)
    NUM_WORKERS: int =  max(2, os.cpu_count()//2) if hasattr(os, "cpu_count") and os.cpu_count() else 2
