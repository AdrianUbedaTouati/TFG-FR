...
H: int = 1440   # horas de entrada (historia)
L: int = 120  # horas de salida (horizonte)
...
HP_SEARCH_ENABLED: bool = False   # Activa/desactiva búsqueda
HP_SEARCH: str = "random"        # "grid" | "random" si HP_SEARCH_ENABLED=True
SEARCH_PARAM_GRID = {
