...
class Config:
    ...
    # Objetivo (Summary)
    LABEL_COL_RAW: Optional[str] = "Precip Type"       # si existe en texto
    SUMMARY_ONEHOT_PREFIX: str = "Precip Type_"        # si hay columnas one-hot
    ...
    FEATURE_COLS: List[str] = field(default_factory=lambda: [
        "h_sin","h_cos","dow_sin","dow_cos","doy_sin","doy_cos","Humidity_normalized",
