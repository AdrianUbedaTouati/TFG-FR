...
class Config:
    ...
    FEATURE_COLS: Optional[List[str]] = field(default_factory=lambda: [
       "h_sin","h_cos","dow_sin","dow_cos","doy_sin","doy_cos","Precip Type_normalized","Humidity_normalized",
       "Wind Speed (km/h)_normalized","wind_bearing_sin","wind_bearing_cos","Visibility (km)_normalized",
       "Pressure (millibars)_normalized","trend_normalized","Summary_Clear","Summary_Foggy","Summary_Mostly Cloudy",
       "Summary_Overcast","Summary_Partly Cloudy","Temperature (C)_normalized","Apparent Temperature (C)_normalized"
    ])
    ...
    # Ventanas
    # --------------------
    H: int = 336      # recomendación: 168 si quieres entreno más rápido
    L: int = 24
