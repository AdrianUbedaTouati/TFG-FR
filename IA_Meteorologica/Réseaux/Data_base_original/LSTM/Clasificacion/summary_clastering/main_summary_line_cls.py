...
class Config:
    ...
    # Objetivo (Summary)
    LABEL_COL_RAW: Optional[str] = "Summary_k5"       # si existe en texto
    SUMMARY_ONEHOT_PREFIX: str = "Summary_normalized_"        # si hay columnas one-hot
    FORCE_TOPK: Optional[int] = 5              # limitar nº de clases (e.g., 5). None => todas
    FORCE_TOPK_DROP_OTHERS: bool = True        # si True, descarta filas fuera del top-k
    ...
    FEATURE_COLS: List[str] = field(default_factory=lambda: [
        ...
        "Precip Type_rain","Precip Type_snow","Humidity_normalized",
