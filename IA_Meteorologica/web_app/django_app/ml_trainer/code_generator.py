...
def _generate_sklearn_header(model_def) -> List[str]:
    ...
    header_lines = [
        ...
        f'- Validation size: {split_config.get("val_size", 0.15) if split_config.get("use_validation", True) else "0 (disabled)"}',
        f'- Test size: {split_config.get("test_size", 0.15)}',
        f'- Use validation: {split_config.get("use_validation", True)}',
        '',
