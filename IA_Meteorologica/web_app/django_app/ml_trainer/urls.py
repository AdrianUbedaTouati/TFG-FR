...
urlpatterns = [
    ...
    path('datasets/split-counts/', views.get_split_counts, name='dataset-split-counts'),
    path('datasets/download-split/', views.download_split_data, name='dataset-download-split'),
    ...
    path('training-sessions/<int:pk>/download-model/', views.DownloadModelView.as_view(), name='download-model'),
